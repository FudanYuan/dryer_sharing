...
<head>
    ...
    <script src="../../common/bootstrap/js/moment.js"></script>
    <script src="../../common/bootstrap/js/daterangepicker.js"></script>
...
<div class="result">
    ...
    <label class="statistic_sum">
        ...
        <label id="money" style="width: 140px"><span id="label">总金额：</span><span id="moneySum"></span></label>
        <label id="broke" style="width: 140px"><span id="label">佣金：</span><span id="brokeSum"></span></label>
    </label>
...
<script>
    ...
    function query() {
        ...
        var data = "merchant=" + getCheckBox('merchant')
            + "&pro=" + (getCheckBox('prov') == null ? "不限" : getCheckBox('prov'))
            + "&city=" + (getCheckBox('city') == null ? "不限" : getCheckBox('city'))
            + "&dist=" + getInput('dist')
            + "&beginTime=" + beginTime
            + "&endTime=" + endTime;
...
//                }
    ...
    // 动态显示
    function drawMyChart(xAxis, timeMax, moneyMax, time, money) {
        myChart.setOption({
            xAxis: [
                {
                    name: '时间',
    ...
    function getMer() {
        var obj;
        obj = document.getElementById("merchant"); //定位id
        var index = obj.selectedIndex; // 选中索引
        var merchant = obj.options[index].text; // 选中文本
        return merchant;
    }
</script>
